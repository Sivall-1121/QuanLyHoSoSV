...
namespace BTL1.thongtin
{
    public partial class frm_tt_monhoc : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void frm_tt_monhoc_Load(object sender, EventArgs e)
        {
            ...
            dgvmh.Columns[1].HeaderText = "Tên Môn Học";
            dgvmh.Columns[2].HeaderText = "Số Tiết";
            dgvmh.Columns[3].HeaderText = "Mã Giáo Viên";
        ...
        {
            inthongtinmonhoc inthongtinmonhoc = new inthongtinmonhoc();
            inthongtinmonhoc.Show();
        }
