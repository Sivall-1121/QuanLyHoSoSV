...
namespace BTL1.quanlytaikhoan
{
    public partial class frm_qltk_admin : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void btnthem_Click(object sender, EventArgs e)
        {
           ...
           if (txttdn.Text == "")
            ...
            else
            {
                ...
                {
                    string sql2 = "Insert into login values('" + txttdn.Text + "', '" + txtmk.Text + "',N'"+txthoten.Text+"','admin','0')";
        ...
        private void frm_qltk_admin_Load(object sender, EventArgs e)
        {
            ...
            con.Open();
            string sql = "Select * from login where quyen='admin'";
            ...
            dgvadmin.Columns[2].HeaderText = "Họ Tên";
            dgvadmin.Columns[3].HeaderText = "Quyền";
            dgvadmin.Columns[4].HeaderText = "Trạng Thái";
            
            dgvadmin.Columns[0].Width = 200;
            dgvadmin.Columns[1].Width = 200;
            dgvadmin.Columns[2].Width = 200;
            dgvadmin.Columns[3].Width = 200;
            dgvadmin.Columns[4].Width = 200;
            dgvadmin.AllowUserToAddRows = false; //Không cho người dùng thêm dữ liệu trực tiếp
  ...
  MessageBoxButtons.YesNo, MessageBoxIcon.Question);
        ...
        private void dgvadmin_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            txttdn.Text = dgvadmin.CurrentRow.Cells[0].Value.ToString();
            txtmk.Text = dgvadmin.CurrentRow.Cells[1].Value.ToString();
            txthoten.Text = dgvadmin.CurrentRow.Cells[2].Value.ToString();
        }

        private void dgvadmin_CellContentClick_1(object sender, DataGridViewCellEventArgs e)
        {
            txttdn.Text = dgvadmin.CurrentRow.Cells[0].Value.ToString();
            txtmk.Text = dgvadmin.CurrentRow.Cells[1].FormattedValue.ToString();
            txthoten.Text = dgvadmin.CurrentRow.Cells[2].Value.ToString();
        }
